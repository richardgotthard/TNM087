...
%% Who has done it
%
% Authors: ricgo595 and marfr808, as in the Lisam submission
...
% Create an image that shows the position of the selected pixel in the IR-image, using a red mark.
